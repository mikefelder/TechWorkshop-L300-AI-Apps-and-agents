...
# from app.tools.singleAgentExample import generate_response - single agent example
from app.tools.aiSearchTools import product_recommendations # multi-agent example
from app.tools.imageCreationTool import create_image # multi-agent example
from app.servers.mcp_inventory_server import mcp as inventory_mcp # multi-agent example
from services.handoff_service import HandoffService # multi-agent example
...
inventory_mcp_app = inventory_mcp.sse_app() # multi-agent example
app.mount("/mcp-inventory/", inventory_mcp_app) # multi-agent example
